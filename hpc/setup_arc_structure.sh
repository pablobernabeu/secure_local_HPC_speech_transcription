...
mkdir -p "$PERSONAL_DIR/setup"   # Installation and configuration scripts
...
- `setup/`: Installation and configuration scripts (Python utilities)
...
echo "   ├── setup/            (Installation scripts)"
...
echo "2. Copy setup scripts to: $PERSONAL_DIR/setup/"
echo "3. Copy data files to: $PERSONAL_DIR/data/"
